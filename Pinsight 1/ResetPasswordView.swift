...
struct ResetPasswordView: View {
    ...
    var body: some View {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 40) {
                        ...
                        VStack(spacing: 15) {
                            ...
                            Text("Set a strong password to protect your account.")
                            ...
                            PrimaryButton(
                                ...
                                action: {
                                    if newPassword == confirmPassword {
                                        viewModel.resetPassword(email: email, newPass: newPassword)
                                    } else {
                                        viewModel.errorMessage = "Passwords do not match"
                                    }
                                },
                                isEnabled: !viewModel.isLoading && !newPassword.isEmpty,
        ...
        .onChange(of: viewModel.resetSuccess) { oldValue, newValue in
...
#Preview {
    ResetPasswordView(email: "test@example.com", isAdmin: false)
}
